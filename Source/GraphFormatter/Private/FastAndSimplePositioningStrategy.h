...
{
	TMultiMap<FFormatterNode*, FFormatterNode*> ConflictMarks;
	...
	TArray<FFormatterNode*> GetSortedAdjacencies(FFormatterNode* Node, bool bUppers) const;
	void Initialize();
	void MarkConflicts();
...
public:
	explicit FFastAndSimplePositioningStrategy(
